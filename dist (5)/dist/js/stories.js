...
(function () {
  ...
  function getStories() {
    return fetch("assets/js/stories.".concat(lang, ".json")).then((function (res) {
      return res.json();
    })).then((function (data) {
  ...
  function imageElement(_ref) {
    var src = _ref.src,
        altText = _ref.altText;
    return createElement('div', {
      class: 'our-plans__image'
    }, [createElement('div', {
      class: 'our-plans__image-container'
    }, [createElement('img', {
      src: src,
      alt: altText
    })])]);
  ...
  function textElement(_ref2) {
    ...
    return createElement('div', {
      class: 'our-plans__text'
    }, [createElement('div', {
      class: 'our-plans__date'
    }, [date]), imageElement(picture), createElement('h2', {}, [heading]), createElement('div', {
      class: 'deck'
  ...
  function segment(story) {
    return createElement('div', {
      class: 'our-plans__segment'
    }, [imageElement(story.picture), textElement(story)]);
  }
